...
export const en = {
  ...
  // Sequence selection table (multi-night downloads)
  "sequenceTable.colSel": "Sel.",
  "sequenceTable.colDate": "Date",
  "sequenceTable.colTransit": "Transit",
  "sequenceTable.colDarks": "Darks",
  "sequenceTable.colTotal": "Total",
  "sequenceTable.selectedCount": "{selected} of {total} sequences selected",
  "sequenceTable.selectAll": "Select all",
  "sequenceTable.selectNone": "None",
  "sequenceTable.toggleAria": "Select sequence {date}",
  "sequenceTable.transitTickTitle": "Contains the predicted transit",

  // Transit cross-check (NASA Exoplanet Archive). Single prediction
  // from the "most precise" ephemeris (réplica del TransitView).
  ...
  "transit.midpoint": "Predicted midpoint:",
  ...
  // FITS viewer: per-image checklist (below the group table)
  "imageTable.title": "Individual images",
  "imageTable.colSel": "Sel.",
  "imageTable.colFile": "File",
  "imageTable.colDate": "Date",
  "imageTable.colWeather": "Sky %",
  "imageTable.colFilter": "Filter",
  "imageTable.colTelescope": "Telescope",
  "imageTable.toggleAria": "Select {file}",
  "imageTable.toggleAllAria": "Select all images",
  "imageTable.selectedCount": "{selected} of {total} selected",
  "imageTable.selectAll": "All",
  "imageTable.selectNone": "None",
  "imageTable.viewButton": "View",
  "imageTable.viewAria": "View FITS of {file}",
  "imageTable.expandAria": "Expand/collapse images of {date}",
  "imageTable.empty": "No images in this session",

  // FITS viewer: modal
  "viewer.title": "FITS viewer — {file}",
  "viewer.close": "Close",
  "viewer.closeAria": "Close viewer",
  "viewer.prev": "← Previous",
  "viewer.next": "Next →",
  "viewer.prevAria": "Previous image",
  "viewer.nextAria": "Next image",
  "viewer.position": "{current} of {total}",
  "viewer.discard": "Discard",
  "viewer.discardAria": "Discard this image from the download",
  "viewer.discarded": "Image discarded",
  "viewer.loading": "Processing FITS…",
  "viewer.error": "Could not load FITS: {msg}",
  "viewer.metadata": "Metadata",
  "viewer.metadata.object": "Object: {value}",
  "viewer.metadata.telescope": "Telescope: {value}",
  "viewer.metadata.filter": "Filter: {value}",
  "viewer.metadata.exptime": "Exposure: {value} s",
  "viewer.metadata.dateObs": "Date obs: {value}",
  "viewer.metadata.bitpix": "BITPIX: {value}",
  "viewer.metadata.dimensions": "Dimensions: {width}×{height}",
  "viewer.metadata.min": "Min: {value}",
  "viewer.metadata.max": "Max: {value}",
  "viewer.metadata.mean": "Mean: {value}",
  "viewer.metadata.unknown": "(unknown)",
  "viewer.allDiscarded": "All images in this session are discarded",
